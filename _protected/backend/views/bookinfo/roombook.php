        ...
        $(function () {
            ...
            $('body').on('click', '.room-book', function() {
                ...
                if (keys.length == 0) {
                    ...
                    notify('<?=Yii::t("messages", "Please select one room you want book")?>');
                    return;
                }
                    ...
                    $.ajax({
                        ...
                        success: function(msg){
                            ...
                            if (msg == '1') {
                                swal({   
                                    title: "<?=Yii::t('messages', 'Are you sure?')?>",   
                                    text: "<?=Yii::t('messages', 'Do you want to change the state of this room?')?>",   
                                    type: "warning",   
                                    showCancelButton: true,   
                                    confirmButtonColor: "#DD6B55",   
                                    confirmButtonText: "<?=Yii::t('messages', 'Yes')?>",   
                                    ...
                                    if (isConfirm) {
                                        ...
                                        swal("<?=Yii::t('messages', 'Cancelled!')?>", "<?=Yii::t('messages', 'The information of the current room remains safe')?>", "error");   
                                        return false;
                                    } 
                                }); 
                            } else {
...
<?php Pjax::begin(); ?>
 <?=Html::beginForm(['guest/recursivebooking', 'lang'=>Yii::$app->request], 'POST');?>
<div class="card table-responsive book-index card-padding">
