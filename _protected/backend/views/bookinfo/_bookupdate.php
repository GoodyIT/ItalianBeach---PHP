    ...
    <?php $form = ActiveForm::begin([
        ...
        'enableAjaxValidation' => false,
            ...
            <div class="row">
                ...
                <input type="hidden" class="servicetype" name="Book[servicetype]" value="<?=$keys[0]?>">
                <input type="hidden" class='maxguests' name="Book[guests]" value="<?=$guestsList['1']?>">
                <input type="hidden" class='hidden-price' name="Book[price]" value="<?=$price?>">
                
                <input type="hidden" class="mainprice" name="Book[mainprice]" value="<?=$service['mainprice']?>">
                <input type="hidden" class="tax" name="Book[tax]" value="<?=$service['tax']?>">
                <input type="hidden" class="supplement" name="Book[supplement]" value="<?=$service['supplement']?>">
            </div>
        <br/>
   
    <?= Html::submitButton(Yii::t('messages', 'CONFIRM BOOKING'),  ['class' => 'btn btn-success confirmbook text-center']) ?>
    <?php ActiveForm::end(); ?>
     </div>
</div>
