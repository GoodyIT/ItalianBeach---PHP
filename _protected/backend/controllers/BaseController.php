...
class BaseController extends Controller
{
	...
	public function buildEmailBody($array, $lang = "en") {
        ...
        '<div><b>- ' . $array["seat"][0] == 1 ? Yii::t('messages', 'Book') : Yii::t('messages', 'Sunshade') .': </b>' . $array["seat"] . '</div>
        '.
        ...
        '.
        '<div><b>- ' . Yii::t('messages', 'checkin Date') .': </b>' . date_format(date_create($array["checkin"]), 'jS F Y') . '</div>
        '.
