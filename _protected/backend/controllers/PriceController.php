...
class PriceController extends BaseController
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['index', 'update', 'create', 'view', 'logout', 'delete'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionCreate()
    {
        ...
        if (Yii::$app->request->post('Price')) {
           ...
           // return;
           $model = Price::savePrice(Yii::$app->request->post('Price'));
          //  $result = Rowrestriction::addServicetype($model['rowid'], $model['servicetype_Id']);
           // print_r($model);
           // return;
            return $this->redirect(['view', 'id' => $model['Id']]);
        } else {
